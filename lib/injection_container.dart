...
Future<void> init() async {
  ...
  // Bloc
  sl.registerFactory(() => RecipesSelectionBloc(getRecipeItems: sl()));

  // Use Cases
  sl.registerLazySingleton(() => get_recipe_items.GetRecipeItems(repository: sl()));

  // Repository
  sl.registerLazySingleton<RecipesSelectionRepository>(() => RecipesSelectionRepositoryImpl(
        recipeSelectionRemoteDatasource: sl(),
        networkInfo: sl(),
  ));

  // Data Sources
  sl.registerLazySingleton<RecipesSelectionRemoteDatasource>(
